...
namespace Entitas {
    ...
    public abstract class ReactiveSystem : SystemBase, IReactiveSystem {

		readonly MonitorList _monitors;
        string _toStringCache;
		
        protected ReactiveSystem(World world):base(world) {
            _monitors = new MonitorList();
        }

		protected ReactiveSystem(World world, params IMonitor[] monitors):base(world) {
